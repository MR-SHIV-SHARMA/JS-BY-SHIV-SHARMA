...
const promiseOne = new Promise(function (resolve, reject) {
  // new Promise() y hi aapka promis  ; is function ke do part hote hai (resolve, reject) in dono ka mtlab hai ki ya to promise pura hoga ya nhi hoga bus itna hi hai
  //Do an async task
