...
// const allHeros = marvel_heros.concat(dc_heros)          //y hmare sbhi arrays ko jode kar array me convert kar deta hai
// console.log(allHeros);

const all_new_heros = [...marvel_heros, ...dc_heros]; //y hmare sbhi arrays ko tod kr ek array me convert kar deta hai

// console.log(all_new_heros);

const another_array = [1, 2, 3, [4, 5, 6], 7, [6, 7, [4, 5]]];

const real_another_array = another_array.flat(Infinity); //y hmare sbhi arrays ko tod kr ek array me convert kar deta hai
